...
export class Header {
  ...
  public static readonly HEADER_SIGNATURE = [
    0xe1,
    0x1a,
    0xb1,
    0xa1,
  ...
  public static readonly SECTOR_SHIFT_VERSION_3_INT: number = Math.pow(
    2,
    Long.fromBytesLE(Header.SECTOR_SHIFT_VERSION_3).toNumber()
  );
  public static readonly MINI_SECTOR_SHIFT_VERSION_3 = [0x06, 0x00];
  public static readonly MINI_SECTOR_SHIFT_VERSION_3_INT = Math.pow(
    2,
    Long.fromBytesLE(Header.MINI_SECTOR_SHIFT_VERSION_3).toNumber()
  );
  public static readonly MINI_STREAM_CUTOFF_SIZE_INT = 0x00001000;
  public static readonly MINI_STREAM_CUTOFF_SIZE = Long.fromValue(
    Header.MINI_STREAM_CUTOFF_SIZE_INT
  ).to4BytesLE();
  ...
  static empty(dataView: CFDataview): Header {
    dataView
      .subView(
        Header.FLAG_POSITION.SIGNATURE,
        Header.FLAG_POSITION.SIGNATURE + 8
      )
      .writeAt(0, Header.HEADER_SIGNATURE);
    dataView
      .subView(
        Header.FLAG_POSITION.MINOR_VERSION,
        Header.FLAG_POSITION.MINOR_VERSION + 2
      )
      .writeAt(0, Header.MINOR_VERSION_3);
    dataView
      .subView(
        Header.FLAG_POSITION.MAJOR_VERSION,
        Header.FLAG_POSITION.MAJOR_VERSION + 2
      )
      .writeAt(0, Header.MAJOR_VERSION_3);
    dataView
      .subView(
        Header.FLAG_POSITION.BYTE_ORDER,
        Header.FLAG_POSITION.BYTE_ORDER + 2
      )
      .writeAt(0, Header.BYTE_ORDER_LITTLE_ENDIAN);
    dataView
      .subView(
        Header.FLAG_POSITION.SECTOR_SHIFT,
        Header.FLAG_POSITION.SECTOR_SHIFT + 2
      )
      .writeAt(0, Header.SECTOR_SHIFT_VERSION_3);
    dataView
      .subView(
        Header.FLAG_POSITION.MINI_SECTOR_SHIFT,
        Header.FLAG_POSITION.MINI_SECTOR_SHIFT + 2
      )
      .writeAt(0, Header.MINI_SECTOR_SHIFT_VERSION_3);
    dataView
      .subView(
        Header.FLAG_POSITION.MINI_STREAM_CUTOFF_SIZE_POSITION,
        Header.FLAG_POSITION.MINI_STREAM_CUTOFF_SIZE_POSITION + 4
      )
    ...
    dataView
      .subView(
        Header.FLAG_POSITION.FIRST_DIFAT_SECTOR,
        Header.FLAG_POSITION.FIRST_DIFAT_SECTOR + 4
      )
      .writeAt(0, ENDOFCHAIN_MARK);
    dataView
      .subView(
        Header.FLAG_POSITION.FIRST_MINIFAT_SECTOR,
        Header.FLAG_POSITION.FIRST_MINIFAT_SECTOR + 4
      )
      .writeAt(0, ENDOFCHAIN_MARK);
    dataView
      .subView(
        Header.FLAG_POSITION.FIRST_DIRECTORY_SECTOR,
        Header.FLAG_POSITION.FIRST_DIRECTORY_SECTOR + 4
      )
      .writeAt(0, ENDOFCHAIN_MARK);
    dataView
      .subView(Header.FLAG_POSITION.DIFAT_ENTRIES_FIRST_POSITION, 512)
      .fill(FREESECT_MARK_OR_NOSTREAM);
  ...
  constructor(dataView: CFDataview) {
    ...
    this.difatEntries = new DifatEntries(
      this.dataView.subView(Header.FLAG_POSITION.DIFAT_ENTRIES_FIRST_POSITION)
    );
  }
  ...
  getNumberOfFatSectors(): number {
    return Long.fromBytesLE(
      this.dataView
        .subView(
          Header.FLAG_POSITION.NUMBER_OF_FAT_SECTORS,
          Header.FLAG_POSITION.NUMBER_OF_FAT_SECTORS + 4
        )
        .getData()
    ).toNumber();
  }
  ...
  getNumberOfMiniFatSectors(): number {
    return Long.fromBytesLE(
      this.dataView
        .subView(
          Header.FLAG_POSITION.NUMBER_OF_MINIFAT_SECTORS,
          Header.FLAG_POSITION.NUMBER_OF_MINIFAT_SECTORS + 4
        )
        .getData()
    ).toNumber();
  }
  ...
  getNumberOfDifatSectors(): number {
    return Long.fromBytesLE(
      this.dataView
        .subView(
          Header.FLAG_POSITION.NUMBER_OF_DIFAT_SECTORS,
          Header.FLAG_POSITION.NUMBER_OF_DIFAT_SECTORS + 4
        )
        .getData()
    ).toNumber();
  }
